...
const components = {
  ...
  h2: ({ className, ...props }: { className?: string }) => (
    <h2
      className={cn(
        "mt-5 scroll-m-5 text-3xl tracking-tight first:mt-0",
        className
      )}
      {...props}
    />
  ...
  ul: ({ className, ...props }: { className?: string }) => (
    <ul className={cn("ml-7 prose list-disc dark:prose-invert text-gray-500 dark:text-gray-400", className)} {...props} />
  ),
  // Komponen ol dengan style tambahan untuk margin dan list style
  ol: ({ className, ...props }: { className?: string }) => (
    <ol className={cn("prose prose-ol:my-6 ml-6 list-decimal", className)} {...props} />
  ),
  ...
  // Komponen b dengan style tambahan untuk font weight
  b: ({ className, ...props }: { className?: string }) => (
    <b
